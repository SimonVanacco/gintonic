...
class AdminController extends AbstractController {
    ...
    public function ordersCountWidget(OrderRepository $repository) {
        ...
        return $this->render('admin/widgets/_simple_count.html.twig', ['label' => $this->translator->trans('Orders'), 'count' => $count, 'icon' => 'fas fa-receipt']);
    }
    ...
    public function todayOrdersCountWidget(OrderRepository $repository) {
        ...
        return $this->render('admin/widgets/_simple_count.html.twig', ['label' => $this->translator->trans('Orders today'), 'count' => $count, 'icon' => 'fas fa-receipt']);
    }
